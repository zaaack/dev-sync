...
var ScpSync = /** @class */ (function () {
    ...
    ScpSync.resolveConf = function () {
        ...
        var DevSyncFile = './devSync.json';
        if (foy_1.fs.existsSync(DevSyncFile)) {
            conf = foy_1.fs.readJsonSync(DevSyncFile);
        }
        else {
            var pkg = require('./package.json');
            if (!pkg.devSync) {
                throw new Error("Cannot find devSync config in ./devSync.json or package.json['devSync']");
            }
            conf = pkg.devSync;
        }
    ...
    ScpSync.prototype.resolveFile = function (file) {
        var relatedPath = path_1.default.relative(this.conf.watchDir, path_1.default.resolve(this.conf.watchDir, file));
        return path_1.default.resolve(this.conf.remoteFolder, relatedPath);
    };
    ScpSync.prototype.scp = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, foy_1.spawn('scp', __spreadArray(__spreadArray([], (this.conf.scpParams || [])), [
                            file,
    ...
    ScpSync.prototype.watch = function () {
        var _this = this;
        foy_1.fs.watchDir(this.conf.watchDir, function (event, file) {
            foy_1.logger.log('watch', event, file);
            if (event !== 'delete') {
                _this.scp(file);
            }
            else {
                _this.ssh("rm -rf " + _this.resolveFile(file));
            }
        });
    ...
    ScpSync.prototype.startCmd = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.ssh("cd " + this.conf.remoteFolder + ";" + this.conf.startCmd)];
            });
        });
    };
